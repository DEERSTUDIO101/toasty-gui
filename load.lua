...
local grid = ScriptsTab:AddScriptGrid({
    scripts = {
        { id="blox-fruits", name="Blox Fruits", type="Premium", placeId="2753915549", link="" },
        { id="pet-sim-x",   name="Pet Sim X",   type="Ad",      placeId="6284583030", link="https://toastyhub.com/key/pet-sim-x" },
    },
    user  = user,
